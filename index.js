...
const getLines = () => {
  ...
  const lineCount = Math.floor(
    w / (w > 500 ? lineDistance : mobileLineDistance)
  );
...
const openMobileButton = document.querySelector(
  ".header nav .menuButton button.open"
);
const closeMobileButton = document.querySelector(
  ".header nav .menuButton button.close"
);
// const closeMobileButton = document.querySelector('')
